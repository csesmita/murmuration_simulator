...
python3 eagle_simulation.py temp.tr.YH no yes -1 -1 100 98 0 2 5 MEAN 0 0 ATC 10000 10 10000 yes 8 2 no DLWL 0 0 no FCFS no && mv finished_file yaqd.10000J.1000X.10000N.YH
python3 eagle_simulation.py temp.tr.YH yes yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 10000 no 0 2 no Hawk 0 0 no FCFS no && mv finished_file hawk.10000J.1000X.10000N.YH
python3 eagle_simulation.py temp.tr.YH no yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 10000 yes 0 20 yes Eagle 0 0 no FCFS no && mv finished_file eagle.10000J.1000X.10000N.YH 
...
python3 eagle_simulation.py temp.tr.YH no yes -1 -1 100 98 0 2 5 MEAN 0 0 ATC 10000 10 5000 yes 8 2 no DLWL 0 0 no FCFS no && mv finished_file yaqd.10000J.1000X.5000N.YH 
python3 eagle_simulation.py temp.tr.YH yes yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 5000 no 0 2 no Hawk 0 0 no FCFS no && mv finished_file hawk.10000J.1000X.5000N.YH 
python3 eagle_simulation.py temp.tr.YH no yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 5000 yes 0 20 yes Eagle 0 0 no FCFS no && mv finished_file eagle.10000J.1000X.5000N.YH 
...
python3 eagle_simulation.py temp.tr.YH no yes -1 -1 100 98 0 2 5 MEAN 0 0 ATC 10000 10 15000 yes 8 2 no DLWL 0 0 no FCFS no && mv finished_file yaqd.10000J.1000X.15000N.YH 
python3 eagle_simulation.py temp.tr.YH yes yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 15000 no 0 2 no Hawk 0 0 no FCFS no && mv finished_file hawk.10000J.1000X.15000N.YH 
python3 eagle_simulation.py temp.tr.YH no yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 15000 yes 0 20 yes Eagle 0 0 no FCFS no && mv finished_file eagle.10000J.1000X.15000N.YH 
...
'
python3 eagle_simulation.py temp.tr.YH no yes -1 -1 100 98 0 2 5 MEAN 0 0 ATC 10000 10 1000 yes 8 2 no DLWL 0 0 no FCFS no && mv finished_file yaqd.10000J.1000X.1000N.YH 
python3 eagle_simulation.py temp.tr.YH yes yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 1000 no 0 2 no Hawk 0 0 no FCFS no && mv finished_file hawk.10000J.1000X.1000N.YH 
python3 eagle_simulation.py temp.tr.YH no yes 90.5811 90.5811 100 98 0 2 5 MEAN 0 0 ATC 10000 10 1000 yes 0 20 yes Eagle 0 0 no FCFS no && mv finished_file eagle.10000J.1000X.1000N.YH 
: '
